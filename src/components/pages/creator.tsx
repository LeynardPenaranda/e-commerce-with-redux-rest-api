    ...
    <div className="grid lg:grid-cols-2 h-[80vh]">
      <div className="flex flex-col items-center justify-center p-4 gap-5">
        ...
        <p className="max-w-2xl text-justify break-words">
          ...
          road to mastery is built on persistence, not giant leaps. Even on slow
          days, remember that each lesson, mistake, and victory is shaping you
          into someone stronger than yesterday.
        </p>
